...
(function () {
  ...
  Zotero.GoogleDocs.UI = {
    ...
    insertLink: async function (text, url) {
      ...
      let textInput = document.getElementsByClassName('docs-link-insertlinkbubble-text')[0]; // Sudden 2021-05-03 change
  ...
  Zotero.GoogleDocs.UI.Menu = class extends React.Component {
    ...
    render() {
      ...
      if (this.state.displayAddNoteButton) {
        addNoteMenuItem = React.createElement(Zotero.GoogleDocs.UI.Menu.Item, {
          label: "Add note...",
          handleClick: this.props.execCommand.bind(this, 'addNote', null)
        });
      }
